...
3. **20 Newsgroups** (18k документов)
   ...
   - Требования:
     ...
     - Сохранение списка условий
     - Сохранение отказ от ответственности
     - Разрешено коммерческое использование
...
- AG News и 20 Newsgroups разрешены для коммерческого использования
- При публикации результатов необходимо указать источники всех датасетов
